...
([
  ...
  function ($routeProvider) {
    ...
    .when("/NewView1/:params*?", {controller: "NewView1Ctrl", templateUrl: "app/views/NewView1.html"});
  }
]);
...
$rootScope.App.ID = "com.appbuilder.dropdown";
$rootScope.App.Name = "Dropdown (Created with an unregistered version of DecSoft's App Builder)";
$rootScope.App.ShortName = "Dropdown";
...
$rootScope.Button1 = {
  ...
  PopoverPos: "top",
  Icon: "",
  Text: "Colors <i class='fa fa-caret-down'></i>",
  Class: "uib-dropdown-toggle btn btn-info btn-md ",
  Disabled: ""
};
$rootScope.Button1.Items.push("Red");
$rootScope.Button1.Items.push("Green");
$rootScope.Button1.Items.push("Blue");
...
window.App.Ctrls.controller("NewView1Ctrl", ["$scope", "$rootScope", "$routeParams", "$sce", "$timeout", "$interval", "$http", "$uibPosition", "$templateCache", "blockUI", "AppPluginsService",
...
$rootScope.NewView1.Params = window.App.Utils.parseViewParams($routeParams.params);
...
$rootScope.Button1.ItemClick = function(index) {
  $rootScope.Button1.ItemIndex = index;

$rootScope.SelectedItem = $rootScope.Button1.Items[$rootScope.Button1.ItemIndex];
...
$rootScope.Result = $rootScope.Button1.Items.indexOf("Pink");

if ($rootScope.Result == -1) {

$rootScope.Button1.Items.push("<li class=\x22divider\x22></li>");

$rootScope.Button1.Items.push("Pink");
...
$rootScope.Result = $rootScope.Button1.Items.indexOf("Yellow");

if ($rootScope.Result == -1) {

$rootScope.Button1.Items.unshift("Yellow");
